function walletWin() {
    ...
    var self, androidshift = 0, loadinLabel, chargeBtn, balancCurr, img, loginBtn, msgLabel, auth = require('/lib/auth'), balanceTitle;
    ...
    Ti.App.addEventListener('showWalletAfterLogin', function() {
        ...
        var loadinLabel, chargeBtn, img, balanceLbl, balancCurr;
